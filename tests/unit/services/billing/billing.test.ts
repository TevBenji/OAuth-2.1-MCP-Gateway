...
describe('BillingService', () => {
  ...
  beforeEach(() => {
    ...
    (mockUsageService.getTenantBilling as Mock).mockClear();
    (mockUsageService.getCurrentUsage as Mock).mockClear();
  });
  ...
  describe('isUsageWithinLimits', () => {
    it('should return false if no billing info exists', async () => {
      (mockUsageService.getTenantBilling as Mock).mockResolvedValueOnce(null);
    ...
    it('should return true if no usage data exists', async () => {
      (mockUsageService.getTenantBilling as Mock).mockResolvedValueOnce({
      ...
      (mockUsageService.getCurrentUsage as Mock).mockResolvedValueOnce(null);
    ...
    it('should return false if usage exceeds limits', async () => {
      ...
      (mockUsageService.getCurrentUsage as Mock).mockResolvedValueOnce({
        tenant_id: 'test-tenant-id',
  ...
  describe('generateUsageReport', () => {
    it('should generate a detailed usage report', async () => {
      ...
      (mockUsageService.getUsageAlerts as Mock).mockResolvedValueOnce([]);
...
// Define Mock type for TypeScript
type Mock = vi.Mock<any, any>;