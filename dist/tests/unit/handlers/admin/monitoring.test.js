...
import { metricsEndpoint, authMetricsEndpoint, tokenLatencyEndpoint, MetricsCollector } from '../../../src/handlers/admin/metrics';
import { ConsoleAlertHandler, EmailAlertHandler, WebhookAlertHandler } from '../../../src/services/security/alerts';
describe('Monitoring and Health Check System', () => {
    ...
    describe('Alerting System', () => {
        ...
        it('should handle errors in alert handlers gracefully', async () => {
            ...
            alertingSystem.registerAlertHandler(faultyHandler);
            const alert = {
                id: 'test-alert-1',
                type: 'security',
                severity: 'high',
