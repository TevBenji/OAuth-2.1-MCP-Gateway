...
describe('UsageTrackingService', () => {
    ...
    describe('recordUsage', () => {
        it('should record a usage event successfully', async () => {
            ...
            expect(mockD1Database.prepare).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO usage_records'));
    ...
    describe('getCurrentUsage', () => {
        it('should return current usage from KV', async () => {
            ...
            expect(mockKVNamespace.get).toHaveBeenCalledWith(expect.stringMatching(/^usage:test-tenant-id:\d{4}-\d{2}$/), 'json');
        });
    ...
    describe('getHistoricalUsage', () => {
        it('should return historical usage records from database', async () => {
            ...
            expect(mockD1Database.prepare).toHaveBeenCalledWith(expect.stringContaining('SELECT * FROM usage_records'));
        });
    });
    describe('getUsageAlerts', () => {
        it('should return active usage alerts for a tenant', async () => {
            ...
            expect(mockD1Database.prepare).toHaveBeenCalledWith(expect.stringContaining('SELECT * FROM usage_alerts'));
        });
    });
    describe('createUsageAlert', () => {
        it('should create a new usage alert', async () => {
            ...
            expect(mockD1Database.prepare).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO usage_alerts'));
        });
    });
});
