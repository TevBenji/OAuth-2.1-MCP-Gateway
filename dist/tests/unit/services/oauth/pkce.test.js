...
import { generatePKCE, validatePKCE, isValidCodeVerifier, isValidCodeChallenge } from '@/services/oauth/pkce';
describe('PKCE Service', () => {
    ...
    describe('validatePKCE', () => {
        ...
        it('should reject unsupported method', async () => {
            const pkce = await generatePKCE();
            await expect(validatePKCE(pkce.code_verifier, pkce.code_challenge, 'plain')).rejects.toThrow('Only S256 PKCE method is supported');
        });
    });
