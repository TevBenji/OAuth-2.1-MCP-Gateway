...
import { DEFAULT_RATE_LIMIT_TIERS, } from '../../src/types/rate-limit';
...
describe('Rate Limiting Security Tests', () => {
    ...
    describe('Burst Protection', () => {
        it('should handle burst requests appropriately', async () => {
            ...
            const results = await Promise.all(Array.from({ length: 20 }, () => limiter.checkTenantLimit(tenantId)));
    ...
    describe('Concurrent Request Handling', () => {
        it('should handle concurrent requests accurately', async () => {
            ...
            const results = await Promise.all(Array.from({ length: 100 }, () => limiter.checkTenantLimit(tenantId)));
