...
describe('IdP Federation Integration Tests', () => {
    ...
    describe('OIDC Federation', () => {
        ...
        it('should exchange authorization code for tokens', async () => {
            ...
            const tokens = await oidcService.exchangeCode(mockOIDCConfig, 'auth_code_123', 'https://gateway.example.com/callback', 'verifier123');
        ...
        it('should extract Microsoft Entra claims', () => {
            ...
            const extracted = oidcService.extractProviderClaims(IdPProvider.MICROSOFT_ENTRA, rawClaims);
    ...
    describe('JIT User Provisioning', () => {
        ...
        it('should reject provisioning when disabled', async () => {
            ...
            await expect(provisioningService.provisionUser(disabledConfig, {
                idp_user_id: 'user123',
                email: 'user@example.com',
                email_verified: true,
    ...
    describe('SAML Federation', () => {
        it('should build SAML AuthnRequest', () => {
            ...
            const authUrl = samlService.buildAuthenticationUrl(mockConfig, 'request123', 'https://gateway.example.com/callback/saml', 'state123');
