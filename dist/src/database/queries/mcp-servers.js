...
export class MCPServerQueries {
     ...
     */
    async getServerById(serverId, tenantId) {
        const query = `
      SELECT
        server_id,
        tenant_id,
     ...
     */
    async getServersByTenant(tenantId) {
        const query = `
      SELECT
        server_id,
        tenant_id,
     ...
     */
    async getServerByResourceIdentifier(resourceIdentifier, tenantId) {
        const query = `
      SELECT
        server_id,
        tenant_id,
     ...
     */
    async updateServerHealth(serverId, tenantId, health) {
        const query = `
      UPDATE mcp_servers
      SET
        health_status = ?,
     ...
     */
    async incrementAccessCount(serverId, tenantId) {
        const query = `
      UPDATE mcp_servers
      SET
