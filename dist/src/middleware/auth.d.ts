 ...
 */
export declare function authMiddleware(): (c: Context, next: Next) => Promise<any>;
/**
 * Optional authentication middleware that allows requests without tokens
 * but validates tokens if present
 */
export declare function optionalAuthMiddleware(): (c: Context, next: Next) => Promise<any>;
/**
 * Scope validation middleware
 * Checks if the token has the required scopes
 */
export declare function requireScopes(...requiredScopes: string[]): (c: Context, next: Next) => Promise<any>;
