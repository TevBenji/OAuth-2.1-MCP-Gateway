 ...
 */
export const createInvalidRequestError = (details, state) => {
...
export const createUnauthorizedClientError = (reason, state) => {
    return new OAuthError({
...
export const createAccessDeniedError = (reason, state) => {
    return new OAuthError({
        error: 'access_denied',
...
export const createUnsupportedResponseTypeError = (responseType, state) => {
    return new OAuthError({
...
export const createInvalidScopeError = (scope, state) => {
    return new OAuthError({
        error: 'invalid_scope',
...
export const createServerError = (details) => {
    return new OAuthError({
        error: 'server_error',
...
export const createTemporarilyUnavailableError = (reason) => {
    return new OAuthError({
 ...
 */
export const createInvalidPKCEError = (reason, state) => {
    return new OAuthError({
        error: 'invalid_request',
 ...
 */
export const createInvalidGrantError = (reason) => {
    return new OAuthError({
        error: 'invalid_grant',
        error_description: reason,
...
export const createInvalidClientError = (reason) => {
    return new OAuthError({
...
export const createUnsupportedGrantTypeError = (grantType) => {
    return new OAuthError({
