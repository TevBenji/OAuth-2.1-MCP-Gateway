...
import { IdPError } from '../../types/idp';
/**
 * Handle OIDC callback
 */
export async function handleOIDCCallback(c) {
    try {
 ...
 */
export async function handleSAMLCallback(c) {
    try {
 ...
 */
export async function handleInitiateAuth(c) {
    try {
 ...
 */
function getCallbackUrl(c, idpType) {
