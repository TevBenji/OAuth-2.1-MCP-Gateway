 ...
 */
export async function registerTenant(c) {
    try {
 ...
 */
export async function getOnboardingStatus(c) {
...
function getMaxMCPServers(tier) {
    const limits = {
        standard: 3,
        enterprise: 100,
        hipaa: 50,
...
function getAuditRetention(tier) {
    const retention = {
        standard: 365,
