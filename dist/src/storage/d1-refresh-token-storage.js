 ...
 */
export class D1RefreshTokenStorage {
    db;
    tenantId;
     ...
     */
    async storeRefreshToken(refreshToken, accessToken, clientId, userId, scopes, expiresAt) {
      ...
      `)
            .bind(tokenHash, clientId, userId, this.tenantId, scopes.join(' '), new Date(expiresAt).toISOString())
            .run();
    }
    /**
