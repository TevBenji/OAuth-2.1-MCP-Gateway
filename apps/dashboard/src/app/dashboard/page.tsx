...
export default function DashboardPage() {
  ...
  // Prevent hydration mismatch by ensuring client-side render
  useEffect(() => {
    setMounted(true);
  }, []);
  ...
  return (
    <div className="space-y-6" suppressHydrationWarning>
      ...
      {!onboardingLoading && !onboardingCompleted && showOnboardingPrompt && (
        <div className="bg-gradient-to-r from-wise-green-50 to-wise-green-100/50 border border-wise-green-200 rounded-lg p-6 shadow-sm">
      ...
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-center md:justify-between" suppressHydrationWarning>
        <div>
